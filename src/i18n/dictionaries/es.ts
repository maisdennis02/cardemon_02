...
const es: Dictionary = {
  ...
  emails: {
    ...
    proEnding: {
      ...
      greeting: "Hola,",
      body: "Tu suscripción Pro de menulala está programada para terminar el {date}. Después, tu cuenta vuelve al plan Gratuito: tu menú público sigue en línea, pero solo podrás mantener hasta {freeLimit} páginas de menú y no podrás añadir más hasta que vuelvas a suscribirte.",
      bodyTomorrow: "Tu suscripción Pro de menulala termina mañana, {date}. Después, tu cuenta vuelve al plan Gratuito: tu menú público sigue en línea, pero solo podrás mantener hasta {freeLimit} páginas de menú y no podrás añadir más hasta que vuelvas a suscribirte.",
