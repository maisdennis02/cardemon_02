...
const es: Dictionary = {
  ...
  emails: {
    ...
    proEnding: {
      subject: "Tu plan Pro de menulala termina el {date}",
      subjectTomorrow: "Tu plan Pro de menulala termina mañana",
      preheader: "Renueva ahora y nada cambia.",
      greeting: "Hola,",
      body: "Tu suscripción Pro de menulala está programada para terminar el {date}. Después, tu cuenta vuelve al plan Gratuito: tu menú público y todas sus páginas actuales siguen en línea, pero el plan Gratuito permite hasta {freeLimit} páginas, así que no podrás añadir nuevas hasta que vuelvas a suscribirte.",
      bodyTomorrow: "Tu suscripción Pro de menulala termina mañana, {date}. Después, tu cuenta vuelve al plan Gratuito: tu menú público y todas sus páginas actuales siguen en línea, pero el plan Gratuito permite hasta {freeLimit} páginas, así que no podrás añadir nuevas hasta que vuelvas a suscribirte.",
      cta: "Renovar suscripción",
      renewNote: "¿Cambiaste de idea? Abre tu panel, haz clic en \"Gestionar suscripción\" y elige Renovar — tu tarjeta, precio y menú se quedan exactamente como están.",
      ignoreNote: "Si querías cancelar, no tienes que hacer nada — tu menú sigue funcionando en el plan Gratuito.",
      signature: "— el equipo de menulala",
    },
    proEnded: {
      subject: "Tu plan Pro de menulala ha terminado",
      preheader: "Tu menú sigue en línea — ahora en el plan Gratuito.",
      greeting: "Hola,",
      body: "Tu suscripción Pro de menulala ha terminado y tu cuenta está ahora en el plan Gratuito. Tu menú público sigue en línea. El plan Gratuito permite hasta {freeLimit} páginas de menú, así que no podrás añadir páginas nuevas más allá de eso hasta que vuelvas a suscribirte.",
      cta: "Suscribirme de nuevo",
      keepNote: "Todas tus páginas, enlaces y ajustes se conservan — todo vuelve en el momento en que te suscribas otra vez.",
      signature: "— el equipo de menulala",
    },
  },
  dashboard: {
