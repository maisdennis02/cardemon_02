...
const es: Dictionary = {
  ...
  landing: {
    ...
    pain2: "Menús rotos, manchados o desteñidos sobre la mesa.",
    solution2: "Tu menú siempre se ve nuevo en el celular del cliente.",
    ...
    testimonial1Quote:
      "[PLACEHOLDER] Reimprimíamos el menú cada dos meses. Ahora cambio la foto desde el celular y listo.",
    ...
    testimonial2Quote:
      "[PLACEHOLDER] Los clientes dejaron de pedir el menú por WhatsApp. Abren el enlace y ya está.",
