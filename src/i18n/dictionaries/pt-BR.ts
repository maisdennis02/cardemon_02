...
const ptBR: Dictionary = {
  ...
  landing: {
    ...
    testimonial1Quote:
      "[PLACEHOLDER] A gente reimprimia o cardápio a cada dois meses. Agora troco a foto pelo celular e tá pronto.",
    ...
    testimonial2Quote:
      "[PLACEHOLDER] Cliente parou de pedir o cardápio no WhatsApp. Abre o link e pronto.",
