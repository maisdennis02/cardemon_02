...
const ptBR: Dictionary = {
  ...
  emails: {
    ...
    proEnding: {
      ...
      greeting: "Olá,",
      body: "Sua assinatura Pro do menulala está programada para terminar em {date}. Depois disso, sua conta volta para o plano Gratuito: seu cardápio público continua no ar, mas você só poderá manter até {freeLimit} páginas de cardápio e não poderá adicionar mais até assinar novamente.",
      bodyTomorrow: "Sua assinatura Pro do menulala termina amanhã, {date}. Depois disso, sua conta volta para o plano Gratuito: seu cardápio público continua no ar, mas você só poderá manter até {freeLimit} páginas de cardápio e não poderá adicionar mais até assinar novamente.",
