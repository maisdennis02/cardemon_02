export const en = {
  ...
  emails: {
    ...
    proEnding: {
      ...
      greeting: "Hi,",
      body: "Your menulala Pro subscription is set to end on {date}. After that your account returns to the Free plan: your public menu stays online, but you'll only be able to keep up to {freeLimit} menu pages and won't be able to add more until you subscribe again.",
      bodyTomorrow: "Your menulala Pro subscription ends tomorrow, {date}. After that your account returns to the Free plan: your public menu stays online, but you'll only be able to keep up to {freeLimit} menu pages and won't be able to add more until you subscribe again.",
