export const en = {
  ...
  emails: {
    ...
    proEnding: {
      subject: "Your menulala Pro plan ends on {date}",
      subjectTomorrow: "Your menulala Pro plan ends tomorrow",
      preheader: "Renew now and nothing changes.",
      greeting: "Hi,",
      body: "Your menulala Pro subscription is set to end on {date}. After that your account returns to the Free plan: your public menu and all its current pages stay online, but the Free plan allows up to {freeLimit} pages, so you won't be able to add new ones until you subscribe again.",
      bodyTomorrow: "Your menulala Pro subscription ends tomorrow, {date}. After that your account returns to the Free plan: your public menu and all its current pages stay online, but the Free plan allows up to {freeLimit} pages, so you won't be able to add new ones until you subscribe again.",
      cta: "Renew subscription",
      renewNote: "Changed your mind? Open your dashboard, click \"Manage subscription\" and choose Renew — your card, price and menu stay exactly as they are.",
      ignoreNote: "If you meant to cancel, there's nothing to do — your menu keeps working on the Free plan.",
      signature: "— the menulala team",
    },
    proEnded: {
      subject: "Your menulala Pro plan has ended",
      preheader: "Your menu is still online — now on the Free plan.",
      greeting: "Hi,",
      body: "Your menulala Pro subscription has ended and your account is now on the Free plan. Your public menu is still online. The Free plan allows up to {freeLimit} menu pages, so you won't be able to add new pages beyond that until you subscribe again.",
      cta: "Subscribe again",
      keepNote: "All your menu pages, links and settings are kept — everything is back the moment you resubscribe.",
      signature: "— the menulala team",
    },
  },
  dashboard: {
