...
export function OnboardingForm() {
  const [state, action, pending] = useActionState(createRestaurant, { error: undefined as string | undefined });
  ...
  return (
    <section className="rounded border border-gray-200 p-6">
      ...
      <p className="mb-4 text-sm text-gray-600">
        Choose a name and a public URL slug. Customers will visit
        <code className="ml-1 rounded bg-gray-100 px-1">/m/&lt;slug&gt;</code>.
      </p>
